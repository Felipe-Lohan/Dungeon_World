...
choose two effects instead of one.

* ☐ **Duelist’s Parry:** When you **Hack & Slash**, you take +1 armor forward.
...
* ☐ **Multiclass İnitiate:** Get one move from another class. Treat your level as one lower for choosing the move.
...
* ☐ **Vicious Blast:** _Replaces: Vicious Cacophony_. When you **grant bonus damage with Arcane Art**, you grant an extra +2d4 damage.
...
* ☐ **Eldritch Chord:** _Replaces: Eldritch Tones_. When you use **Arcane Art**, you choose two effects. You also get to choose one of those effects to double.
...
* ☐ **Duelist’s Block:** Replaces: _Duelist’s Parry_. When you **Hack & Slash**, you take +2 armor forward.

* ☐ **Con:** _Replaces: Bamboozle_. When you **parley with someone**, on a 7+ you also take +1 forward with them and get to ask their player one question which they must answer truthfully.
